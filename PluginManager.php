...
class PluginManager extends AbstractPluginManager
{
    ...
    const ADMIN_TEMPLATE_FILE = 'CustomerChangeNotify/CustomerChangeNotify/Mail/customer_change_admin_mail';

    /** @var string 会員向けメールテンプレの file_name */
    const MEMBER_TEMPLATE_FILE = 'CustomerChangeNotify/CustomerChangeNotify/Mail/customer_change_member_mail';
